...
function sortedJsonAscByName(jsonArr) {
  return jsonArr.sort((a, b) => {
...
app.get('/drinks/:id', function (req, res) {
  const { id } = req.params;
  const recipe = drinks.find((d) => d.id === parseInt(id));
...
app.get('/recipes', function (req, res) {
  const sortedJson = sortedJsonAscByName(recipes);
  res.json(sortedJson);
});
...
app.get('/drinks', function (req, res) {
  const sortedJson = sortedJsonAscByName(drinks);
  res.json(sortedJson);
});
