...
# retorna o prato mais pedido por uma determinada pessoa cliente,
# considerando que os pedidos estão em uma lista.

# get_order_frequency_per_costumer é uma função que
# retorna a frequência que uma determinada pessoa cliente
# pede um determinado prato, considerando que os pedidos estão em uma lista.
...
# novamente adicionamos um cenário (contexto) ao teste
# onde os pedidos realizados são os definidos na fixture
